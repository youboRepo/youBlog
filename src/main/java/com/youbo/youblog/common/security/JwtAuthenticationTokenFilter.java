...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    private SecurityUser getSecurityUser(String token) {
        ...
        ParserConfig.getGlobalInstance()
            .putDeserializer(SwitchUserGrantedAuthority.class, new GrantedAuthorityDeserializer());
        TypeUtils.addMapping("org.springframework.security.web.authentication.switchuser.SwitchUserGrantedAuthority",
